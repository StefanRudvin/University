...
class Vertex {
    ...
    public Map<String, Assessment.mud.Edge> _routes; // Association between direction
    ...
    public Vertex(String nm) {
        _name = nm;
        _routes = new HashMap<String, Assessment.mud.Edge>(); // Not synchronised
    ...
    public String toString() {
        ...
        while (iter.hasNext()) {
            ...
            summary += "To the " + direction + " there is " + ((Assessment.mud.Edge) _routes.get(direction))._view + "\n";
        }
